...
# $latest_version
xraycore_link="https://github.com/XTLS/Xray-core/releases/download/v1.6.6-2/Xray-linux-64.zip"
...
sed -i '$ ilocation = /vmess /worryfree /kuota-habis' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/MXVXID/vx/main/v2/sesah/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/MXVXID/vx/main/v2/xray/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/MXVXID/vx/main/v2/xray/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
